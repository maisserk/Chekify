...
export const WeatherModule: React.FC<WeatherModuleProps> = ({ 
  ...
  return (
    <div className={`w-full bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-white/10 max-h-[82vh] sm:max-h-[86vh] overflow-y-auto overscroll-contain scrollbar-thin ${isEmbedded ? 'rounded-2xl p-4' : 'rounded-3xl p-4 sm:p-6 shadow-2xl dark:shadow-none'}`}>
